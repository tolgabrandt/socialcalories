    ...
    <div className="w-full flex flex-col gap-16">
      ...
      <section className="flex-auto w-fullh-full">
        <div className="max-w-[1140px] mx-auto flex gap-16 flex-wrap ">
          <form className="flex flex-col gap-4 w-[360px]">
            <h2 className="text-4xl font-black text-slate-600 mb-8 border-b-4 py-8 border-emerald-500">
              Randevu Formu
            </h2>
            <input className="" type="text" placeholder="Adınız Soyadınız" />
            <input className="" type="text" placeholder="E-Posta Adresiniz" />
            <input className="" type="text" placeholder="Telefon Numaranız" />
            <input className="" type="text" placeholder="Şehir" />
            <button>Sizi Arayalım</button>
          </form>
          <section className="flex-auto w-[600px] h-[600px]">
            <iframe
